...
namespace :db do
  ...
  task populate_dntg: :environment do
    ...
    if File.exist?("lib/assets/dntg-imported.txt")
      IO.foreach('lib/assets/dntg-imported.txt') do |line|
        sentence = line.split("\t")[0]
        filename = line.split("\t")[1]
        puts filename, sentence
        entry3 = line.split("\t")[2]
      ...
      IO.foreach('lib/assets/dntg-transformed.txt') do |line|
        entry1 = line.split("\t")[0]
        entry2 = line.split("\t")[1]
        entry1.delete!("\n") unless entry1 == ""
        entry2.delete!("\n") unless entry2 == ""
        ...
        File.open("lib/assets/dntg-imported.txt", 'a') do |file|
          file.puts([entry1.to_s, filename.to_s, vocabulary.to_s, words.to_s, pinyin.to_s].join("\t"))
        end
      end
    end
  ...
  task populate_lsj: :environment do
    ...
    if File.exist?("lib/assets/lsj-imported.txt")
      IO.foreach('lib/assets/lsj-imported.txt') do |line|
        sentence = line.split("\t")[0]
        filename = line.split("\t")[1]
        puts filename, sentence
        entry3 = line.split("\t")[2]
      ...
      IO.foreach('lib/assets/lsj-transformed.txt') do |line|
        entry1 = line.split("\t")[0]
        entry2 = line.split("\t")[1]
        entry1.delete!("\n") unless entry1 == ""
        entry2.delete!("\n") unless entry2 == ""
        ...
        File.open("lib/assets/lsj-imported.txt", 'a') do |file|
          file.puts([entry1.to_s, filename.to_s, vocabulary.to_s, words.to_s, pinyin.to_s].join("\t"))
        end
      end
    end
